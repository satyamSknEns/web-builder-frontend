...
//                 <div
//                   ref={popupRef}
//                   className="mt-4 bg-white shadow-md rounded-lg  border border-gray-400 absolute -bottom-100 left-[350px] overflow-y-scroll flex h-[407px] w-[700px]"
//                 >
          ...
          {activeTab === "content" && (
            <div>
              ...
              {showSectionPopup && (
                <div
                  ref={popupRef}
                  className={` slide-top mt-4 bg-white shadow-md rounded-lg border border-gray-400 absolute left-[350px] w-[700px] h-[360px] overflow-y-scroll flex transform transition-transform duration-1000 ease-in-out`}
                >
                  <div className="overflow-y-scroll h-full w-[35%] p-1">
                    <div className="rounded-lg">
                      <input
